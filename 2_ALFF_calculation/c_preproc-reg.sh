...
ls -d sub* > /nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/filelist-all2461.txt
...
Sessions=`cat ${rtpath}/Sleep_EEG_fMRI-main_v202410/filelist-all2461.txt`
...
3drefit -Tslices `cat ${rtpath}/Sleep_EEG_fMRI-main_v202410/2_ALFF_calculation/SliceTimes.1D` ${session}_RPI.nii.gz



rm -f preproc_reg.fsf
cp ${rtpath}/Sleep_EEG_fMRI-main_v202410/preproc_reg.fsf .
