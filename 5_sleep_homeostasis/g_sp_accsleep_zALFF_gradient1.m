...
figure
set(gcf,'Units','Centimeters','position',[1 1 6.5 5.5])
...
ax = gca;
set(ax, 'xtick',-6:3:6, 'ytick',-1:0.5:1);
...
% from spin model
txt={'{\it{r}} = 0.35','{\it{P}} = 0.0010'}; % use r from v6 data
t=text(3.0,0.69,txt,'left');
