...
maskfile2 = ['/nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/raichle/mask_glycolysis_6mm.nii.gz'];
...
cd(outpath)
%%% lme
lmefile1 = ['lme_ALFF-ctx-z_2stages_age_gender_edu_N2180-s-v6.nii.gz'];
lme10 = load_nifti(lmefile1);
lme1 = reshape(lme10.vol,[dim(1)*dim(2)*dim(3) 10]);

beta1_mask = lme1(find(mask12>0),9); % Sleep vs. W
...
cd /nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/raichle
...
set(gca,'xtick',-2:2:2)
set(gca,'YLim',[-1.4 1.9])
set(gca, 'ytick',-1:1:1);

txt={'{\it{r}} = -0.39','{\it{P}} = 0.0052'};
t=text(-3.3,1.6,txt,'left');
t.FontSize=7;t.FontName='Arial';t.Color='k'


outpath = ['/nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/6_metabolism_alignment'];
cd(outpath)


print(gcf,'-dpdf','-r400')
oldname=['figure1.pdf'];
newname=['Sleep_W_ALFF_glycolysis_100deciles_n.pdf'];
...
txt={'{\it{r}} = 0.43','{\it{P}} = 0.0009'};
t=text(-4.1,1.6,txt,'left');
t.FontSize=7;t.FontName='Arial';t.Color='k'
