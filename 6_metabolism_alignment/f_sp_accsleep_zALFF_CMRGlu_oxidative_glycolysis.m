...
lme1_mask = lme1_mask1(:,13)-lme1_mask1(:,11);
...
% [r_real; p]
%     -0.0006    0.5057    0.2462
%     0.9677    0.0000    0.0000
...
ylabel('{\Delta} ALFF_{Late} vs. {\Delta} ALFF_{Early}','fontname','Arial','fontsize',7);
set(gca,'XLim',[-3.5 2.8])
set(gca,'xtick',-2:2:2)
set(gca,'YLim',[-0.7 0.7])
set(gca, 'ytick',-0.5:0.5:0.5);

txt={'{\it{r}} = 0.51','{\it{P}} < 0.0001'};
...
print(gcf,'-dpdf','-r400')
oldname=['figure1.pdf'];
newname=['accsleep_ALFF_glycolysis_100deciles_n.pdf'];
