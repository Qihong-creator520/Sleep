...
clc;clear
TR = 2;
Demo=readtable('/nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/Demo_N130.txt');
                        ...
                        for j=1:stgs(i,6) % epoches
                           ...
                           for d=1:size(Demo,1)
                               if  strcmp(subjects{epoch_num_a,1},Demo(d,1).Var1)
                                   age{epoch_num_a,1}=Demo(d,3).Var3;
                                   if Demo(d,4).Var4==0 % gender as categorical variable
                                       gender{epoch_num_a,1}='female';
                                   else
                                       gender{epoch_num_a,1}='male';
                                   end
                                   edu{epoch_num_a,1}=Demo(d,5).Var5; 
                               end
                           end
...
clc;clear
Model_N2461=readtable('/nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/EEG/Model_N2461_forEEG.txt');
...
for_EEG_N2180  = Model_N2461(index_N2180,[6 7 9]);

cd /nd_disk2/qihong/Sleep_PKU/brain_restoration/Sleep_EEG_fMRI-main_v202410/EEG/
writetable(for_EEG_N2180,'for_EEG_N2180.txt','Delimiter',' ')
